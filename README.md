# Frontend Mentor - Inicia o cronômetro de contagem regressiva

![Visualização do design para o desafio de codificação do cronômetro de contagem regressiva de lançamento](./design/desktop-preview.jpg)
...
Seu desafio é construir esse cronômetro de contagem regressiva e deixá-lo o mais próximo possível do design.
...
- Veja um cronômetro de contagem regressiva ao vivo que diminui a cada segundo (comece a contagem em 14 dias)
- **Bônus**: quando um número mudar, vire a carta do meio
